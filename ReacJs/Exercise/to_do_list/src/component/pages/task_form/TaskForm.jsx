...
function TaskForm({createTask, createKey, updateTask, type, data, taskList}) {
    ...
    const setInitialValues = () => {
        if (type === 'create') {
            ...
            let currentData = taskList.find(task => task.key === parseInt(data));
            return {
                key: parseInt(data),
                status: currentData.status,
                taskName: currentData.taskName,
                startDate: moment(currentData.startDate)
            }
        }
    }
